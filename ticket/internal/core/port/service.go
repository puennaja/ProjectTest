...
type TicketService interface {
	CreateTicket(ctx context.Context, user *domain.User, data *domain.TicketRequest) (*domain.TicketResponse, error)
	...
	UpdateTicket(ctx context.Context, user *domain.User, data *domain.UpdateTicketRequest) (*domain.TicketResponse, error)
	...
	CreateTicketComment(ctx context.Context, user *domain.User, data *domain.TicketCommentRequest) (*domain.TicketCommentResponse, error)
	...
	UpdateTicketComment(ctx context.Context, user *domain.User, data *domain.UpdateTicketCommentRequest) (*domain.TicketCommentResponse, error)
	DeleteTicketComment(ctx context.Context, user *domain.User, id string) (*domain.TicketCommentResponse, error)
}
